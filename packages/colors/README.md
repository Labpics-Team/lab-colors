...
Массив `fgs` передаётся как синхронно заимствованный scratch-буфер: реализация
обязана полностью прочитать его до возврата из вызова и не может удерживать,
кэшировать или читать его асинхронно после возврата.
