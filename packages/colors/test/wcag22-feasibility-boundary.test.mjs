...
test("first-pass CI records and uploads Linux evidence before the immutable #284 size gate", () => {
  const ci = ciSource;
  ...
  assert.match(
    ci,
    /name: "upload exact #295 whole-call candidate before expected size RED"/u,
  );
