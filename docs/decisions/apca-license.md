...
Статус: принято · Дата: 2026-06-10 · Область применения: `crates/labcolors-core/src/lpc.rs`
...
- Метрика называется LPC. Строка «APCA» не должна появляться в публичных API-символах, имени метрики и маркетинговых материалах. Этот файл — единственное место атрибуции: контрастная кривая LPC использует экспоненты и константы отсечки из опубликованной формулы APCA 0.0.98G-4g; LPC не является APCA, не APCA-совместима и не комплаентна, не одобрена Myndex Research или Andrew Somers.
