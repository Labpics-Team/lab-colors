...
| формула | чем верифицирована | оракул |
|---|---|---|
| `linearise` (порог 0.03928, /12.92, γ 2.4) | `[NEW]` `reference_vectors_deep::wcag_linearise_threshold_is_normative_03928` | публикация (W3C WCAG 2.1 §1.4.3, нормативная версия) |
...
> **Находка (зафиксирована в тесте):** порог `0.03928` — нормативная версия
> WCAG 2.1, отличается от erratum-значения `0.04045` (= стык IEC EOTF). Для
> 8-битных входов обе версии выбирают одну ветвь, поэтому квантованные цвета
> линеаризуются идентично; расхождение только на суб-квантовых величинах.
