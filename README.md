...
**Вход:** бренд (якорные цвета) · физика (перцептуальное пространство LCS, гамут sRGB, контраст) · психофизика (эффект Гельмгольца-Кольрауша, перцептуальная светлота, адаптация зрения к окружению, категориальные зоны хью у сентиментов).
...
- **sentiment** — покой сентимента на фокусе своей категориальной зоны
