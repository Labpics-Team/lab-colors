...
- **Несколько видов результата.** Роль может вернуть solid, translucent, material, точечный glow, явное отсутствие значения либо типизированный failure: доказанную недостижимость, исчерпанный ограниченный поиск, отклонённый запрос или неподдержанную возможность.
