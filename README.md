...
Вспомогательные функции с областью видимости пакета разбирают поддерживаемую
цепочку CSS-цветов для runtime-контроллеров. Это не функция публичного
корневого API и не доказательство того, что пользователь видит именно этот
пиксель.
