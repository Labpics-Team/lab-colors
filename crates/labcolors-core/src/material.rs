...
//! заземлённого 12 Figma-парами, но не выдаваемого за любой browser pipeline. WCAG-
...
//! тем же алгоритмом официальный потребитель пересчитывает вердикт из
//! эмитированных `01`/`02`, поэтому его re-check тождествен ядру. Renderer и
//! color-management применимость принадлежат отдельному conformance-гейту.
