...
/// чёрного. Задачи #219/#261 должны вывести зависящий от контекста закон прогрессии
/// либо удалить gamma-параметризацию. Новые рабочие механизмы не должны зависеть от
/// этих чисел.
...
impl Default for CurveParams {
    fn default() -> Self {
        Self {
            ...
            // SSOT-TRACKED — зафиксированная gamma прежней эмиссии; корневая модель
            // прогрессии остаётся открытой в #219/#261.
            gamma_light: 1.75,
