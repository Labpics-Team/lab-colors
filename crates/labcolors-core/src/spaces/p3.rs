...
mod tests {
    ...
    const ORACLE_VECTORS: [([f64; 3], [f64; 3]); 10] = [
        ...
        (
            ...
            [1.000_375_385_576_657, -0.000_342_536_944_987, -0.024_737_474_303_527],
        ),
        // P3 green primary
        (
            [0.2657, 0.6917, 0.0451],
            [0.001_573_973_954_110, 0.999_958_231_674_300, -0.000_112_565_864_141],
        ),
        // P3 blue primary
        (
            [0.1982, 0.0493, 1.0439],
            [0.182_472_899_365_812, -0.682_738_873_275_621, 1.000_984_506_746_989],
        ),
        // D65 white point
        (
            [0.9505, 1.0000, 1.0890],
            [1.000_058_529_397_080, 0.999_983_329_774_657, 0.999_976_402_367_743],
        ),
        // Mid-gamut warm
        (
            [0.3500, 0.2800, 0.1200],
            [0.775_795_182_694_772, 0.491_281_242_493_821, 0.359_195_003_652_463],
        ),
        // Mid-gamut cool
        (
            [0.1800, 0.2200, 0.4500],
            [0.277_758_323_855_466, 0.536_218_733_443_349, 0.680_188_856_941_253],
        ),
        // Near-black
        (
            [0.0050, 0.0050, 0.0050],
            [0.068_382_687_709_650, 0.058_893_447_392_171, 0.056_872_480_609_552],
        ),
        // Near-white
        (
            [0.9000, 0.9500, 1.0200],
            [0.977_042_575_824_772, 0.978_636_668_422_400, 0.971_286_312_321_990],
        ),
        // Saturated mid-lightness
        (
            [0.4000, 0.1500, 0.3000],
            [0.873_967_711_076_929, -0.779_186_763_473_890, 0.574_850_954_277_402],
        ),
        // Low-saturation
        (
            [0.3000, 0.3100, 0.3300],
            [0.606_702_146_996_086, 0.588_576_131_801_128, 0.586_408_108_600_142],
        ),
    ];
