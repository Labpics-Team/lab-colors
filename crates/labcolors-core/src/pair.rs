...
// ─────────────────────────────────────────────────────────────────────────────
// Локи терминала (a) DERIVED `PAIR_CROSSOVER_Y`. Статус и деривация констан-
// ты НЕ трогаются главой #64: тесты предъявляют (1) чистый зазор консенсус-
// сета вокруг порога, (2) пиннинг деривации замером, (3) экспозицию зоны
// флипа; петля консистентности с продакшн-решением учитывает level-3
// (H-K может только ПОДНЯТЬ якорь в чернила, поимённо).
// ─────────────────────────────────────────────────────────────────────────────
#[cfg(test)]
mod exposure_locks {
