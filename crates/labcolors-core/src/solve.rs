...
/// Return the input background itself as a solved colour.
///
/// Background semantic roles are surface colours, not foreground marks: the
/// primary background is the canvas colour the caller already supplied. It still
/// needs to travel through the same [`Solved`] shape as every other colour so the
/// runtime can expose a normal CSS variable instead of a special-case `none`.
pub(crate) fn background_as_solved(bg: &BgInput, vc: &ViewingConditions) -> Result<Solved, Unreachable> {
    match bg {
        BgInput::Solid(rgb) => {
            let y_bg = bg_luma(*rgb, vc);
            let bg_disp = quantised_display(*rgb);
            finish(*rgb, y_bg, bg_disp, false, vc)
        }
    }
}
...
mod tests {
    ...
    fn cam16_forwards_per_set_regression_guard() {
        ...
        // 2026-06-13.
        let expected = [
            (("srgb", "#FFFFFF"), (1209u64, 1082u64)),
            (("srgb", "#7F7F7F"), (936, 796)),
            (("srgb", "#101012"), (1016, 861)),
            (("dim", "#FFFFFF"), (1151, 998)),
            (("dim", "#7F7F7F"), (888, 739)),
            (("dim", "#101012"), (1041, 828)),
        ];
    ...
    /// carries all 26 roles per line (`background-*`, `label-*`, `border-*`,
    ...
    const RESOLVE_SET_GOLDEN: &[&str] = &[
        "srgb|#FFFFFF|Neutral|background-primary=#FFFFFF,background-secondary=#F4F4F4,background-tertiary=#E9E9E9,background-inverted=unreach,background-grouped-primary=#F4F4F4,background-grouped-secondary=#E9E9E9,background-grouped-tertiary=#E1E1E1,label-primary=#141414,label-secondary=#767676,label-tertiary=#949494,label-quaternary=#C2C2C2,border-strong=#141414,border-base=#E9E9E9,border-soft=#F4F4F4,border-ghost=none,border-inverted=unreach,fill-primary=#E4E4E4,fill-secondary=#E9E9E9,fill-tertiary=#EFEFEF,fill-quaternary=#F4F4F4,fill-none=none,shadow-minor=#E9E9E9,shadow-ambient=#E6E6E6,shadow-penumbra=#E3E3E3,shadow-major=#DEDEDE,none=none",
        "srgb|#FFFFFF|Tinted|background-primary=#FFFFFF,background-secondary=#F4F4F5,background-tertiary=#E9E9EB,background-inverted=unreach,background-grouped-primary=#F4F4F5,background-grouped-secondary=#E9E9EB,background-grouped-tertiary=#E0E0E4,label-primary=#0C0C11,label-secondary=#6D6D7E,label-tertiary=#9493A0,label-quaternary=#BEBEC6,border-strong=#0C0C11,border-base=#E9E9EB,border-soft=#F4F4F5,border-ghost=none,border-inverted=unreach,fill-primary=#E4E4E7,fill-secondary=#E9E9EB,fill-tertiary=#EFEFF1,fill-quaternary=#F4F4F5,fill-none=none,shadow-minor=#E8E8EA,shadow-ambient=#E5E5E8,shadow-penumbra=#E1E1E4,shadow-major=#DCDCE0,none=none",
        "srgb|#F2F2F7|Neutral|background-primary=#F2F2F7,background-secondary=#E8E8E8,background-tertiary=#DDDDDD,background-inverted=unreach,background-grouped-primary=#E8E8E8,background-grouped-secondary=#DDDDDD,background-grouped-tertiary=#D5D5D5,label-primary=#131313,label-secondary=#6F6F6F,label-tertiary=#8C8C8C,label-quaternary=#BCBCBC,border-strong=#131313,border-base=#DDDDDD,border-soft=#E8E8E8,border-ghost=none,border-inverted=unreach,fill-primary=#D9D9D9,fill-secondary=#DDDDDD,fill-tertiary=#E3E3E3,fill-quaternary=#E8E8E8,fill-none=none,shadow-minor=#E1E1E1,shadow-ambient=#DFDFDF,shadow-penumbra=#DBDBDB,shadow-major=#D7D7D7,none=none",
        "srgb|#F2F2F7|Tinted|background-primary=#F2F2F7,background-secondary=#E8E8EA,background-tertiary=#DDDDE1,background-inverted=unreach,background-grouped-primary=#E8E8EA,background-grouped-secondary=#DDDDE1,background-grouped-tertiary=#D5D5DA,label-primary=#0C0C10,label-secondary=#69697B,label-tertiary=#8C8B99,label-quaternary=#B8B8C0,border-strong=#0C0C10,border-base=#DDDDE1,border-soft=#E8E8EA,border-ghost=none,border-inverted=unreach,fill-primary=#D8D8DD,fill-secondary=#DDDDE1,fill-tertiary=#E3E3E6,fill-quaternary=#E8E8EA,fill-none=none,shadow-minor=#E0E0E3,shadow-ambient=#DDDDE1,shadow-penumbra=#D9D9DD,shadow-major=#D4D4D9,none=none",
        "srgb|#7F7F7F|Neutral|background-primary=#7F7F7F,background-secondary=#777777,background-tertiary=#6F6F6F,background-inverted=unreach,background-grouped-primary=#777777,background-grouped-secondary=#6F6F6F,background-grouped-tertiary=#696969,label-primary=#070707,label-secondary=#161616,label-tertiary=#363636,label-quaternary=#616161,border-strong=#070707,border-base=#6F6F6F,border-soft=#777777,border-ghost=none,border-inverted=unreach,fill-primary=#6C6C6C,fill-secondary=#6F6F6F,fill-tertiary=#747474,fill-quaternary=#777777,fill-none=none,shadow-minor=#696969,shadow-ambient=#656565,shadow-penumbra=#616161,shadow-major=#5B5B5B,none=none",
        "srgb|#7F7F7F|Tinted|background-primary=#7F7F7F,background-secondary=#767686,background-tertiary=#6E6E7F,background-inverted=unreach,background-grouped-primary=#767686,background-grouped-secondary=#6E6E7F,background-grouped-tertiary=#686779,label-primary=#030304,label-secondary=#16161B,label-tertiary=#363541,label-quaternary=#575667,border-strong=#030304,border-base=#6E6E7F,border-soft=#767686,border-ghost=none,border-inverted=unreach,fill-primary=#6A6A7C,fill-secondary=#6E6E7F,fill-tertiary=#727283,fill-quaternary=#767686,fill-none=none,shadow-minor=#5F5E70,shadow-ambient=#5B5B6C,shadow-penumbra=#575667,shadow-major=#515060,none=none",
        "srgb|#1C1C1E|Neutral|background-primary=#1C1C1E,background-secondary=#242424,background-tertiary=#2B2B2B,background-inverted=unreach,background-grouped-primary=#242424,background-grouped-secondary=#2B2B2B,background-grouped-tertiary=#313131,label-primary=#F6F6F6,label-secondary=#BABABA,label-tertiary=#9A9A9A,label-quaternary=#727272,border-strong=#F6F6F6,border-base=#2B2B2B,border-soft=#242424,border-ghost=none,border-inverted=unreach,fill-primary=#2F2F2F,fill-secondary=#2B2B2B,fill-tertiary=#272727,fill-quaternary=#242424,fill-none=none,shadow-minor=#3F3F3F,shadow-ambient=#434343,shadow-penumbra=#484848,shadow-major=#4F4F4F,none=none",
        "srgb|#1C1C1E|Tinted|background-primary=#1C1C1E,background-secondary=#23232B,background-tertiary=#2A2A34,background-inverted=unreach,background-grouped-primary=#23232B,background-grouped-secondary=#2A2A34,background-grouped-tertiary=#30303A,label-primary=#F6F6F7,label-secondary=#B6B6BF,label-tertiary=#9494A0,label-quaternary=#68687A,border-strong=#F6F6F7,border-base=#2A2A34,border-soft=#23232B,border-ghost=none,border-inverted=unreach,fill-primary=#2E2E38,fill-secondary=#2A2A34,fill-tertiary=#26262F,fill-quaternary=#23232B,fill-none=none,shadow-minor=#363541,shadow-ambient=#3A3945,shadow-penumbra=#3F3F4B,shadow-major=#454553,none=none",
        "srgb|#101012|Neutral|background-primary=#101012,background-secondary=#181818,background-tertiary=#202020,background-inverted=unreach,background-grouped-primary=#181818,background-grouped-secondary=#202020,background-grouped-tertiary=#262626,label-primary=#F6F6F6,label-secondary=#B9B9B9,label-tertiary=#989898,label-quaternary=#6F6F6F,border-strong=#F6F6F6,border-base=#202020,border-soft=#181818,border-ghost=none,border-inverted=unreach,fill-primary=#242424,fill-secondary=#202020,fill-tertiary=#1C1C1C,fill-quaternary=#181818,fill-none=none,shadow-minor=#393939,shadow-ambient=#3D3D3D,shadow-penumbra=#434343,shadow-major=#4A4A4A,none=none",
        "srgb|#101012|Tinted|background-primary=#101012,background-secondary=#18171E,background-tertiary=#1F1F27,background-inverted=unreach,background-grouped-primary=#18171E,background-grouped-secondary=#1F1F27,background-grouped-tertiary=#25252E,label-primary=#F6F6F7,label-secondary=#B5B5BD,label-tertiary=#91919E,label-quaternary=#646477,border-strong=#F6F6F7,border-base=#1F1F27,border-soft=#18171E,border-ghost=none,border-inverted=unreach,fill-primary=#23232B,fill-secondary=#1F1F27,fill-tertiary=#1B1B22,fill-quaternary=#18171E,fill-none=none,shadow-minor=#30303A,shadow-ambient=#34343F,shadow-penumbra=#3A3945,shadow-major=#40404D,none=none",
        "srgb|#3478F6|Neutral|background-primary=#3478F6,background-secondary=#777777,background-tertiary=#6F6F6F,background-inverted=unreach,background-grouped-primary=#777777,background-grouped-secondary=#6F6F6F,background-grouped-tertiary=#696969,label-primary=#0A0A0A,label-secondary=#141414,label-tertiary=#353535,label-quaternary=#757575,border-strong=#0A0A0A,border-base=#6F6F6F,border-soft=#777777,border-ghost=none,border-inverted=unreach,fill-primary=#6B6B6B,fill-secondary=#6F6F6F,fill-tertiary=#737373,fill-quaternary=#777777,fill-none=none,shadow-minor=#848484,shadow-ambient=#818181,shadow-penumbra=#7D7D7D,shadow-major=#777777,none=none",
        "srgb|#3478F6|Tinted|background-primary=#3478F6,background-secondary=#757585,background-tertiary=#6D6D7E,background-inverted=unreach,background-grouped-primary=#757585,background-grouped-secondary=#6D6D7E,background-grouped-tertiary=#676779,label-primary=#050406,label-secondary=#15141A,label-tertiary=#35343F,label-quaternary=#6C6C7D,border-strong=#050406,border-base=#6D6D7E,border-soft=#757585,border-ghost=none,border-inverted=unreach,fill-primary=#69697B,fill-secondary=#6D6D7E,fill-tertiary=#717182,fill-quaternary=#757585,fill-none=none,shadow-minor=#7C7C8C,shadow-ambient=#797989,shadow-penumbra=#747484,shadow-major=#6E6E7F,none=none",
        "dim|#FFFFFF|Neutral|background-primary=#FFFFFF,background-secondary=#E8E8E8,background-tertiary=#D8D8D8,background-inverted=unreach,background-grouped-primary=#E8E8E8,background-grouped-secondary=#D8D8D8,background-grouped-tertiary=#CACACA,label-primary=#131313,label-secondary=#757575,label-tertiary=#949494,label-quaternary=#C0C0C0,border-strong=#131313,border-base=#D8D8D8,border-soft=#E8E8E8,border-ghost=none,border-inverted=unreach,fill-primary=#BEBEBE,fill-secondary=#C4C4C4,fill-tertiary=#D1D1D1,fill-quaternary=#DFDFDF,fill-none=none,shadow-minor=#E7E7E7,shadow-ambient=#E4E4E4,shadow-penumbra=#E0E0E0,shadow-major=#DCDCDC,none=none",
        "dim|#FFFFFF|Tinted|background-primary=#FFFFFF,background-secondary=#E8E8EA,background-tertiary=#D7D7DC,background-inverted=unreach,background-grouped-primary=#E8E8EA,background-grouped-secondary=#D7D7DC,background-grouped-tertiary=#C9C9D0,label-primary=#0E0E12,label-secondary=#6D6C7E,label-tertiary=#9493A0,label-quaternary=#BDBDC5,border-strong=#0E0E12,border-base=#D7D7DC,border-soft=#E8E8EA,border-ghost=none,border-inverted=unreach,fill-primary=#BDBDC4,fill-secondary=#C3C3CA,fill-tertiary=#D1D1D6,fill-quaternary=#DEDFE2,fill-none=none,shadow-minor=#E6E6E8,shadow-ambient=#E3E3E6,shadow-penumbra=#DFDFE3,shadow-major=#DADADF,none=none",
        "dim|#F2F2F7|Neutral|background-primary=#F2F2F7,background-secondary=#DCDCDC,background-tertiary=#CDCDCD,background-inverted=unreach,background-grouped-primary=#DCDCDC,background-grouped-secondary=#CDCDCD,background-grouped-tertiary=#BFBFBF,label-primary=#131313,label-secondary=#6F6F6F,label-tertiary=#8C8C8C,label-quaternary=#BCBCBC,border-strong=#131313,border-base=#CDCDCD,border-soft=#DCDCDC,border-ghost=none,border-inverted=unreach,fill-primary=#B3B3B3,fill-secondary=#B9B9B9,fill-tertiary=#C6C6C6,fill-quaternary=#D3D3D3,fill-none=none,shadow-minor=#E1E1E1,shadow-ambient=#DEDEDE,shadow-penumbra=#DBDBDB,shadow-major=#D6D6D6,none=none",
        "dim|#F2F2F7|Tinted|background-primary=#F2F2F7,background-secondary=#DCDCE0,background-tertiary=#CCCCD2,background-inverted=unreach,background-grouped-primary=#DCDCE0,background-grouped-secondary=#CCCCD2,background-grouped-tertiary=#BFBFC6,label-primary=#0D0D12,label-secondary=#6A6A7B,label-tertiary=#8C8B99,label-quaternary=#B8B8C1,border-strong=#0D0D12,border-base=#CCCCD2,border-soft=#DCDCE0,border-ghost=none,border-inverted=unreach,fill-primary=#B2B2BB,fill-secondary=#B9B9C1,fill-tertiary=#C6C6CC,fill-quaternary=#D3D3D8,fill-none=none,shadow-minor=#E0E0E3,shadow-ambient=#DDDDE1,shadow-penumbra=#D9D9DE,shadow-major=#D5D5D9,none=none",
        "dim|#7F7F7F|Neutral|background-primary=#7F7F7F,background-secondary=#707070,background-tertiary=#656565,background-inverted=unreach,background-grouped-primary=#707070,background-grouped-secondary=#656565,background-grouped-tertiary=#5B5B5B,label-primary=#070707,label-secondary=#161616,label-tertiary=#363636,label-quaternary=#616161,border-strong=#070707,border-base=#656565,border-soft=#707070,border-ghost=none,border-inverted=unreach,fill-primary=#525252,fill-secondary=#575757,fill-tertiary=#606060,fill-quaternary=#696969,fill-none=none,shadow-minor=#696969,shadow-ambient=#666666,shadow-penumbra=#616161,shadow-major=#5B5B5B,none=none",
        "dim|#7F7F7F|Tinted|background-primary=#7F7F7F,background-secondary=#6E6E7F,background-tertiary=#636375,background-inverted=unreach,background-grouped-primary=#6E6E7F,background-grouped-secondary=#636375,background-grouped-tertiary=#59596A,label-primary=#040406,label-secondary=#16161B,label-tertiary=#363541,label-quaternary=#585868,border-strong=#040406,border-base=#636375,border-soft=#6E6E7F,border-ghost=none,border-inverted=unreach,fill-primary=#515160,fill-secondary=#555565,fill-tertiary=#5E5E70,fill-quaternary=#68677A,fill-none=none,shadow-minor=#606072,shadow-ambient=#5D5C6E,shadow-penumbra=#585869,shadow-major=#525262,none=none",
        "dim|#1C1C1E|Neutral|background-primary=#1C1C1E,background-secondary=#282828,background-tertiary=#323232,background-inverted=unreach,background-grouped-primary=#282828,background-grouped-secondary=#323232,background-grouped-tertiary=#3A3A3A,label-primary=#F4F4F4,label-secondary=#B8B8B8,label-tertiary=#989898,label-quaternary=#707070,border-strong=#F4F4F4,border-base=#323232,border-soft=#282828,border-ghost=none,border-inverted=unreach,fill-primary=#424242,fill-secondary=#3E3E3E,fill-tertiary=#363636,fill-quaternary=#2E2E2E,fill-none=none,shadow-minor=#3D3D3D,shadow-ambient=#424242,shadow-penumbra=#474747,shadow-major=#4E4E4E,none=none",
        "dim|#1C1C1E|Tinted|background-primary=#1C1C1E,background-secondary=#282730,background-tertiary=#31313B,background-inverted=unreach,background-grouped-primary=#282730,background-grouped-secondary=#31313B,background-grouped-tertiary=#393945,label-primary=#F3F3F5,label-secondary=#B5B5BD,label-tertiary=#93939F,label-quaternary=#686779,border-strong=#F3F3F5,border-base=#31313B,border-soft=#282730,border-ghost=none,border-inverted=unreach,fill-primary=#41414E,fill-secondary=#3D3D49,fill-tertiary=#353540,fill-quaternary=#2D2C36,fill-none=none,shadow-minor=#363641,shadow-ambient=#3A3A46,shadow-penumbra=#3F3F4C,shadow-major=#464553,none=none",
        "dim|#101012|Neutral|background-primary=#101012,background-secondary=#1C1C1C,background-tertiary=#252525,background-inverted=unreach,background-grouped-primary=#1C1C1C,background-grouped-secondary=#252525,background-grouped-tertiary=#2E2E2E,label-primary=#F4F4F4,label-secondary=#B7B7B7,label-tertiary=#969696,label-quaternary=#6D6D6D,border-strong=#F4F4F4,border-base=#252525,border-soft=#1C1C1C,border-ghost=none,border-inverted=unreach,fill-primary=#353535,fill-secondary=#313131,fill-tertiary=#292929,fill-quaternary=#212121,fill-none=none,shadow-minor=#373737,shadow-ambient=#3C3C3C,shadow-penumbra=#414141,shadow-major=#484848,none=none",
        "dim|#101012|Tinted|background-primary=#101012,background-secondary=#1C1C22,background-tertiary=#25242D,background-inverted=unreach,background-grouped-primary=#1C1C22,background-grouped-secondary=#25242D,background-grouped-tertiary=#2D2C36,label-primary=#F3F3F5,label-secondary=#B3B3BC,label-tertiary=#90909D,label-quaternary=#646476,border-strong=#F3F3F5,border-base=#25242D,border-soft=#1C1C22,border-ghost=none,border-inverted=unreach,fill-primary=#34343F,fill-secondary=#30303B,fill-tertiary=#282831,fill-quaternary=#212028,fill-none=none,shadow-minor=#30303A,shadow-ambient=#34343F,shadow-penumbra=#3A3945,shadow-major=#40404D,none=none",
        "dim|#3478F6|Neutral|background-primary=#3478F6,background-secondary=#6F6F6F,background-tertiary=#646464,background-inverted=unreach,background-grouped-primary=#6F6F6F,background-grouped-secondary=#646464,background-grouped-tertiary=#5B5B5B,label-primary=#0A0A0A,label-secondary=#141414,label-tertiary=#353535,label-quaternary=#757575,border-strong=#0A0A0A,border-base=#646464,border-soft=#6F6F6F,border-ghost=none,border-inverted=unreach,fill-primary=#525252,fill-secondary=#565656,fill-tertiary=#5F5F5F,fill-quaternary=#696969,fill-none=none,shadow-minor=#848484,shadow-ambient=#818181,shadow-penumbra=#7D7D7D,shadow-major=#777777,none=none",
        "dim|#3478F6|Tinted|background-primary=#3478F6,background-secondary=#6D6D7E,background-tertiary=#626275,background-inverted=unreach,background-grouped-primary=#6D6D7E,background-grouped-secondary=#626275,background-grouped-tertiary=#59596A,label-primary=#060608,label-secondary=#15141A,label-tertiary=#35343F,label-quaternary=#6C6C7E,border-strong=#060608,border-base=#626275,border-soft=#6D6D7E,border-ghost=none,border-inverted=unreach,fill-primary=#505060,fill-secondary=#555465,fill-tertiary=#5E5D6F,fill-quaternary=#676779,fill-none=none,shadow-minor=#7D7D8C,shadow-ambient=#797989,shadow-penumbra=#757585,shadow-major=#6F6F80,none=none",
    ];
