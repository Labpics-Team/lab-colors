...
mod tests {
    ...
    fn cam16_forwards_per_set_regression_guard() {
        ...
        // 2026-06-13.
        // Re-measured after DECORATIVE_FLOOR_MIN raise (7.6→15.5) and shadow
        // const lift (8/9.5/11.5/14→17/18.5/20/22): separator + 4 shadow roles
        // now target higher Lc, adding quantisation-gap probe steps on some
        // backgrounds and changing the solver's walk depth.  Updated 2026-06-22.
        let expected = [
            (("srgb", "#FFFFFF"), (1283u64, 1137u64)),
            (("srgb", "#7F7F7F"), (1019, 854)),
            (("srgb", "#101012"), (1058, 899)),
            (("dim", "#FFFFFF"), (1254, 1107)),
            (("dim", "#7F7F7F"), (1047, 861)),
            (("dim", "#101012"), (1170, 945)),
        ];
    ...
    const RESOLVE_SET_GOLDEN: &[&str] = &[
        ...
        // 2026-06-22.  Each delta explained in the PR, tagged R3.
        "srgb|#FFFFFF|Neutral|label-primary=#141414,label-secondary=#767676,label-tertiary=#949494,label-quaternary=#C2C2C2,icon=#949494,separator=#DBDBDB,border-strong=#141414,border-base=#E9E9E9,border-soft=#F4F4F4,border-ghost=none,fill-primary=#E4E4E4,fill-secondary=#E9E9E9,fill-tertiary=#EFEFEF,fill-quaternary=#F4F4F4,fill-none=none,shadow-minor=#D9D9D9,shadow-ambient=#D6D6D6,shadow-penumbra=#D3D3D3,shadow-major=#CFCFCF,none=none",
        "srgb|#FFFFFF|Tinted|label-primary=#0C0C11,label-secondary=#6D6D7E,label-tertiary=#9493A0,label-quaternary=#BEBEC6,icon=#9493A0,separator=#D9D9DE,border-strong=#0C0C11,border-base=#E9E9EB,border-soft=#F4F4F5,border-ghost=none,fill-primary=#E4E4E7,fill-secondary=#E9E9EB,fill-tertiary=#EFEFF1,fill-quaternary=#F4F4F5,fill-none=none,shadow-minor=#D7D7DB,shadow-ambient=#D4D4D9,shadow-penumbra=#D1D1D6,shadow-major=#CDCDD2,none=none",
        "srgb|#F2F2F7|Neutral|label-primary=#131313,label-secondary=#6F6F6F,label-tertiary=#8C8C8C,label-quaternary=#BCBCBC,icon=#8C8C8C,separator=#D4D4D4,border-strong=#131313,border-base=#DDDDDD,border-soft=#E8E8E8,border-ghost=none,fill-primary=#D9D9D9,fill-secondary=#DDDDDD,fill-tertiary=#E3E3E3,fill-quaternary=#E8E8E8,fill-none=none,shadow-minor=#D1D1D1,shadow-ambient=#CECECE,shadow-penumbra=#CCCCCC,shadow-major=#C8C8C8,none=none",
        "srgb|#F2F2F7|Tinted|label-primary=#0C0C10,label-secondary=#69697B,label-tertiary=#8C8B99,label-quaternary=#B8B8C0,icon=#8C8B99,separator=#D1D1D7,border-strong=#0C0C10,border-base=#DDDDE1,border-soft=#E8E8EA,border-ghost=none,fill-primary=#D8D8DD,fill-secondary=#DDDDE1,fill-tertiary=#E3E3E6,fill-quaternary=#E8E8EA,fill-none=none,shadow-minor=#CECED4,shadow-ambient=#CCCCD1,shadow-penumbra=#C9C9CF,shadow-major=#C5C5CB,none=none",
        "srgb|#7F7F7F|Neutral|label-primary=#070707,label-secondary=#161616,label-tertiary=#363636,label-quaternary=#616161,icon=#363636,separator=#575757,border-strong=#070707,border-base=#6F6F6F,border-soft=#777777,border-ghost=none,fill-primary=#6C6C6C,fill-secondary=#6F6F6F,fill-tertiary=#747474,fill-quaternary=#777777,fill-none=none,shadow-minor=#535353,shadow-ambient=#505050,shadow-penumbra=#4C4C4C,shadow-major=#474747,none=none",
        "srgb|#7F7F7F|Tinted|label-primary=#030304,label-secondary=#16161B,label-tertiary=#363541,label-quaternary=#575667,icon=#363541,separator=#4D4D5C,border-strong=#030304,border-base=#6E6E7F,border-soft=#767686,border-ghost=none,fill-primary=#6A6A7C,fill-secondary=#6E6E7F,fill-tertiary=#727283,fill-quaternary=#767686,fill-none=none,shadow-minor=#4A4958,shadow-ambient=#464654,shadow-penumbra=#42424F,shadow-major=#3D3D49,none=none",
        "srgb|#1C1C1E|Neutral|label-primary=#F6F6F6,label-secondary=#BABABA,label-tertiary=#9A9A9A,label-quaternary=#727272,icon=#9A9A9A,separator=#535353,border-strong=#F6F6F6,border-base=#2B2B2B,border-soft=#242424,border-ghost=none,fill-primary=#2F2F2F,fill-secondary=#2B2B2B,fill-tertiary=#272727,fill-quaternary=#242424,fill-none=none,shadow-minor=#575757,shadow-ambient=#5B5B5B,shadow-penumbra=#5E5E5E,shadow-major=#636363,none=none",
        "srgb|#1C1C1E|Tinted|label-primary=#F6F6F7,label-secondary=#B6B6BF,label-tertiary=#9494A0,label-quaternary=#68687A,icon=#9494A0,separator=#494957,border-strong=#F6F6F7,border-base=#2A2A34,border-soft=#23232B,border-ghost=none,fill-primary=#2E2E38,fill-secondary=#2A2A34,fill-tertiary=#26262F,fill-quaternary=#23232B,fill-none=none,shadow-minor=#4D4D5C,shadow-ambient=#515060,shadow-penumbra=#545464,shadow-major=#59596A,none=none",
        "srgb|#101012|Neutral|label-primary=#F6F6F6,label-secondary=#B9B9B9,label-tertiary=#989898,label-quaternary=#6F6F6F,icon=#989898,separator=#4E4E4E,border-strong=#F6F6F6,border-base=#202020,border-soft=#181818,border-ghost=none,fill-primary=#242424,fill-secondary=#202020,fill-tertiary=#1C1C1C,fill-quaternary=#181818,fill-none=none,shadow-minor=#525252,shadow-ambient=#555555,shadow-penumbra=#595959,shadow-major=#5E5E5E,none=none",
        "srgb|#101012|Tinted|label-primary=#F6F6F7,label-secondary=#B5B5BD,label-tertiary=#91919E,label-quaternary=#646477,icon=#91919E,separator=#444451,border-strong=#F6F6F7,border-base=#1F1F27,border-soft=#18171E,border-ghost=none,fill-primary=#23232B,fill-secondary=#1F1F27,fill-tertiary=#1B1B22,fill-quaternary=#18171E,fill-none=none,shadow-minor=#484856,shadow-ambient=#4C4B5A,shadow-penumbra=#4F4F5E,shadow-major=#545464,none=none",
        "srgb|#3478F6|Neutral|label-primary=#0A0A0A,label-secondary=#141414,label-tertiary=#353535,label-quaternary=#757575,icon=#353535,separator=#747474,border-strong=#0A0A0A,border-base=#6F6F6F,border-soft=#777777,border-ghost=none,fill-primary=#6B6B6B,fill-secondary=#6F6F6F,fill-tertiary=#737373,fill-quaternary=#777777,fill-none=none,shadow-minor=#717171,shadow-ambient=#6D6D6D,shadow-penumbra=#6A6A6A,shadow-major=#656565,none=none",
        "srgb|#3478F6|Tinted|label-primary=#050406,label-secondary=#15141A,label-tertiary=#35343F,label-quaternary=#6C6C7D,icon=#35343F,separator=#6A6A7C,border-strong=#050406,border-base=#6D6D7E,border-soft=#757585,border-ghost=none,fill-primary=#69697B,fill-secondary=#6D6D7E,fill-tertiary=#717182,fill-quaternary=#757585,fill-none=none,shadow-minor=#676679,shadow-ambient=#636375,shadow-penumbra=#605F72,shadow-major=#5B5B6C,none=none",
        "dim|#FFFFFF|Neutral|label-primary=#131313,label-secondary=#757575,label-tertiary=#949494,label-quaternary=#C0C0C0,icon=#949494,separator=#D9D9D9,border-strong=#131313,border-base=#D8D8D8,border-soft=#E8E8E8,border-ghost=none,fill-primary=#BEBEBE,fill-secondary=#C4C4C4,fill-tertiary=#D1D1D1,fill-quaternary=#DFDFDF,fill-none=none,shadow-minor=#D7D7D7,shadow-ambient=#D4D4D4,shadow-penumbra=#D1D1D1,shadow-major=#CDCDCD,none=none",
        "dim|#FFFFFF|Tinted|label-primary=#0E0E12,label-secondary=#6D6C7E,label-tertiary=#9493A0,label-quaternary=#BDBDC5,icon=#9493A0,separator=#D8D8DC,border-strong=#0E0E12,border-base=#D7D7DC,border-soft=#E8E8EA,border-ghost=none,fill-primary=#BDBDC4,fill-secondary=#C3C3CA,fill-tertiary=#D1D1D6,fill-quaternary=#DEDFE2,fill-none=none,shadow-minor=#D5D5DA,shadow-ambient=#D2D2D7,shadow-penumbra=#CFCFD4,shadow-major=#CBCBD1,none=none",
        "dim|#F2F2F7|Neutral|label-primary=#131313,label-secondary=#6F6F6F,label-tertiary=#8C8C8C,label-quaternary=#BCBCBC,icon=#8C8C8C,separator=#D4D4D4,border-strong=#131313,border-base=#CDCDCD,border-soft=#DCDCDC,border-ghost=none,fill-primary=#B3B3B3,fill-secondary=#B9B9B9,fill-tertiary=#C6C6C6,fill-quaternary=#D3D3D3,fill-none=none,shadow-minor=#D1D1D1,shadow-ambient=#CECECE,shadow-penumbra=#CBCBCB,shadow-major=#C8C8C8,none=none",
        "dim|#F2F2F7|Tinted|label-primary=#0D0D12,label-secondary=#6A6A7B,label-tertiary=#8C8B99,label-quaternary=#B8B8C1,icon=#8C8B99,separator=#D2D2D7,border-strong=#0D0D12,border-base=#CCCCD2,border-soft=#DCDCE0,border-ghost=none,fill-primary=#B2B2BB,fill-secondary=#B9B9C1,fill-tertiary=#C6C6CC,fill-quaternary=#D3D3D8,fill-none=none,shadow-minor=#CFCFD4,shadow-ambient=#CCCCD2,shadow-penumbra=#C9C9CF,shadow-major=#C5C5CC,none=none",
        "dim|#7F7F7F|Neutral|label-primary=#070707,label-secondary=#161616,label-tertiary=#363636,label-quaternary=#616161,icon=#363636,separator=#575757,border-strong=#070707,border-base=#656565,border-soft=#707070,border-ghost=none,fill-primary=#525252,fill-secondary=#575757,fill-tertiary=#606060,fill-quaternary=#696969,fill-none=none,shadow-minor=#545454,shadow-ambient=#505050,shadow-penumbra=#4C4C4C,shadow-major=#474747,none=none",
        "dim|#7F7F7F|Tinted|label-primary=#040406,label-secondary=#16161B,label-tertiary=#363541,label-quaternary=#585868,icon=#363541,separator=#4F4F5E,border-strong=#040406,border-base=#636375,border-soft=#6E6E7F,border-ghost=none,fill-primary=#515160,fill-secondary=#555565,fill-tertiary=#5E5E70,fill-quaternary=#68677A,fill-none=none,shadow-minor=#4B4B5A,shadow-ambient=#484856,shadow-penumbra=#444452,shadow-major=#3F3F4C,none=none",
        "dim|#1C1C1E|Neutral|label-primary=#F4F4F4,label-secondary=#B8B8B8,label-tertiary=#989898,label-quaternary=#707070,icon=#989898,separator=#525252,border-strong=#F4F4F4,border-base=#323232,border-soft=#282828,border-ghost=none,fill-primary=#424242,fill-secondary=#3E3E3E,fill-tertiary=#363636,fill-quaternary=#2E2E2E,fill-none=none,shadow-minor=#555555,shadow-ambient=#595959,shadow-penumbra=#5D5D5D,shadow-major=#616161,none=none",
        "dim|#1C1C1E|Tinted|label-primary=#F3F3F5,label-secondary=#B5B5BD,label-tertiary=#93939F,label-quaternary=#686779,icon=#93939F,separator=#494957,border-strong=#F3F3F5,border-base=#31313B,border-soft=#282730,border-ghost=none,fill-primary=#41414E,fill-secondary=#3D3D49,fill-tertiary=#353540,fill-quaternary=#2D2C36,fill-none=none,shadow-minor=#4D4D5C,shadow-ambient=#505060,shadow-penumbra=#545464,shadow-major=#595869,none=none",
        "dim|#101012|Neutral|label-primary=#F4F4F4,label-secondary=#B7B7B7,label-tertiary=#969696,label-quaternary=#6D6D6D,icon=#969696,separator=#4C4C4C,border-strong=#F4F4F4,border-base=#252525,border-soft=#1C1C1C,border-ghost=none,fill-primary=#353535,fill-secondary=#313131,fill-tertiary=#292929,fill-quaternary=#212121,fill-none=none,shadow-minor=#505050,shadow-ambient=#545454,shadow-penumbra=#585858,shadow-major=#5C5C5C,none=none",
        "dim|#101012|Tinted|label-primary=#F3F3F5,label-secondary=#B3B3BC,label-tertiary=#90909D,label-quaternary=#646476,icon=#90909D,separator=#444451,border-strong=#F3F3F5,border-base=#25242D,border-soft=#1C1C22,border-ghost=none,fill-primary=#34343F,fill-secondary=#30303B,fill-tertiary=#282831,fill-quaternary=#212028,fill-none=none,shadow-minor=#484856,shadow-ambient=#4B4B5A,shadow-penumbra=#4F4F5E,shadow-major=#545464,none=none",
        "dim|#3478F6|Neutral|label-primary=#0A0A0A,label-secondary=#141414,label-tertiary=#353535,label-quaternary=#757575,icon=#353535,separator=#747474,border-strong=#0A0A0A,border-base=#646464,border-soft=#6F6F6F,border-ghost=none,fill-primary=#525252,fill-secondary=#565656,fill-tertiary=#5F5F5F,fill-quaternary=#696969,fill-none=none,shadow-minor=#717171,shadow-ambient=#6D6D6D,shadow-penumbra=#6A6A6A,shadow-major=#656565,none=none",
        "dim|#3478F6|Tinted|label-primary=#060608,label-secondary=#15141A,label-tertiary=#35343F,label-quaternary=#6C6C7E,icon=#35343F,separator=#6B6B7D,border-strong=#060608,border-base=#626275,border-soft=#6D6D7E,border-ghost=none,fill-primary=#505060,fill-secondary=#555465,fill-tertiary=#5E5D6F,fill-quaternary=#676779,fill-none=none,shadow-minor=#68687A,shadow-ambient=#646476,shadow-penumbra=#616073,shadow-major=#5C5C6E,none=none",
    ];
