...
//!   /private/tmp/labcolors-wcag22-feasibility-admission-raw-v7.json \
...
const ARTIFACT_ID: &str = "wcag22-feasibility-admission-raw-v7";
const DEFAULT_OUTPUT_FILENAME: &str = "labcolors-wcag22-feasibility-admission-raw-v7.json";
