...
//! LABCOLORS_WCAG22_BENCH_OUTPUT=/private/tmp/labcolors-wcag22-feasibility-admission-raw-v4.json \
...
const ARTIFACT_ID: &str = "wcag22-feasibility-admission-raw-v4";
const DEFAULT_OUTPUT_FILENAME: &str = "labcolors-wcag22-feasibility-admission-raw-v4.json";
